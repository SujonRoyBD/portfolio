    ...
    <div className="container py-9">
      ...
      target="_blank"
          ...
          <div className="grid grid-cols-3 md:grid-cols-3 lg:grid-cols-4 gap-3 md:gap-4 lg:gap-9 py-7">
            ...
            <p className="text-violet-500 border rounded-xl border-gray-400 px-2 py-1 text-center">React Js</p>
            <p className="text-violet-500 border rounded-xl border-gray-400 px-2 py-1 text-center">Redux</p>
            <p className="text-violet-500 border rounded-xl border-gray-400 px-2 py-1 text-center">Swiper Js</p>
